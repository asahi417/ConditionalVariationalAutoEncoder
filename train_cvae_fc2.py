...
from model import CVAE_FC2

if __name__ == '__main__':
    # Ignore warning message by tensor flow
    os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2'

    save_path = "./log/cvae_fc2/"
    # network_architecture = dict(n_input=[28, 28, 1], n_z=20)
    model = CVAE_FC2(10, batch_size=100, save_path=save_path, learning_rate=0.005, activation=tf.nn.relu)
    ...
    mnist_train(model=model, epoch=100, save_path=save_path, mode="conditional", input_image=False)
