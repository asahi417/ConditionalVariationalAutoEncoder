...
class ConditionalVAE(object):
    ...
    def __init__(self, label_size, network_architecture, activation=tf.nn.relu, learning_rate=0.001,
                 batch_size=100, save_path=None, load_model=None, max_grad_norm=None):
        """
